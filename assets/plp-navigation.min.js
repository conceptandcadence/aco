$("body").on('click', function (e) {
	if ( [...e.target.classList].includes("plp-products-filter--trigger") ) {
		e.preventDefault();
		setTimeout(() => {
	...
	if ( [...e.target.classList].includes("pagination__link") ) {
		e.preventDefault();
		setTimeout(() => {
          window.scrollTo({
            top: (document.querySelector('#shopify-section-plp-navigation').offsetTop - 105),
            left: 0,
            behavior: "auto",
          });
		}, 100);
...
document.body.setAttribute("style", `--filters-height: ${$(".shop-filters__container").height()}px`);
$(".shop-filters__container").height("var(--filters-height)");
$(".shop-filters__container").removeClass('plp-nav-expanded');
